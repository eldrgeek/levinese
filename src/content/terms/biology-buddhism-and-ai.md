...
A 2022 paper in <em>Entropy</em> by Thomas Doctor, Olaf Witkowski, Elizaveta Solomonova, Bill Duane, and Michael Levin. The core argument is that intelligence, across any embodiment, can be understood as care: the ability to identify problems in some scope and seek their alleviation. Buddhist concepts of suffering and the Bodhisattva vow — the commitment to the liberation of all sentient beings — provide an unusual but structurally precise framing. A system with an infinitely large cognitive light cone would be infinitely intelligent, because its care extends over an infinite problem space.
    <br><br>
